...
UNSAFE_ENTRY(jobject, Unsafe_AllocateInstance(JNIEnv *env, jobject unsafe, jclass cls)) {
  ...
  log_info(gc)("Inside unsafe allocate instance method.");
  return env->AllocObject(cls);
} UNSAFE_END

// UNSAFE_ENTRY(jobject, Unsafe_AllocateNativeInstance(JNIEnv *env, jobject unsafe, jclass cls)) {
//   ThreadToNativeFromVM ttnfv(thread);
//   log_info(gc)("Inside unsafe allocate native instance method.");
//   return env->AllocObject(cls);
// }
...
static JNINativeMethod jdk_internal_misc_Unsafe_methods[] = {
    ...
    // {CC "allocateNativeInstance",   CC "(" CLS ")" OBJ,        FN_PTR(Unsafe_AllocateNativeInstance)},
