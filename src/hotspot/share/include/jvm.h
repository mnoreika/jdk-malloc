...
JNIEXPORT jobject JNICALL
JVM_Allocate(JNIEnv *env, jclass clazz);

JNIEXPORT jobjectArray JNICALL
JVM_AllocateObjectArray(JNIEnv *env, jclass clazz, jint length);

JNIEXPORT jarray JNICALL
JVM_AllocatePrimitiveArray(JNIEnv *env, jint type_code, jint length);

JNIEXPORT void JNICALL
JVM_Free(jobject obj);

JNIEXPORT void JNICALL
JVM_FreeObjectArray(jobjectArray objArray);
